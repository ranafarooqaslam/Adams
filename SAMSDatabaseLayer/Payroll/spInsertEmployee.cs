...
{
    public class spInsertEmployee
    {
        #region Private Members
        private string sp_Name = "spInsertEmployee";
        ...
        public long ExecuteQuery()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                return m_EmployeeID = (long)((IDataParameter)(cmd.Parameters["@EmployeeID"])).Value;
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@IsPFEnabled";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Bit);
            parameter.Value = m_IsPFEnabled;
            pparams.Add(parameter);

...
{
	public class spInsertEmployeeTranscationalArchiveDetail
	{
        #region Private Members
        private string sp_Name = "spInsertEmployeeTranscationalArchiveDetail";
        ...
        private long m_EmployeeTranscationalArchiveDetailID;
        #endregion
        ...
        public long EmployeeTranscationalArchiveDetailID
        {
            get
            {
                return m_EmployeeTranscationalArchiveDetailID;
            }
        }
        ...
        #endregion
        #region Constructor
        public spInsertEmployeeTranscationalArchiveDetail()
        {
        }
        #endregion
        ...
        public long ExecuteQuery()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                return m_EmployeeTranscationalArchiveDetailID = (long)((IDataParameter)(cmd.Parameters["@EmployeeTranscationalArchiveDetailID"])).Value;
        ...
        public void FirstReader(IDataReader dr)
        {
            if (dr.Read())
            {
                ...
                m_EmployeeTranscationalArchiveDetailID = Convert.ToInt64(dr["EmployeeTranscationalArchiveDetailID"]);
            }
        }
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            if (m_EmployeeTranscationalDetailID == Constants.LongNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_EmployeeTranscationalDetailID;
            }
            pparams.Add(parameter);
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@EmployeeTranscationalArchiveDetailID";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.BigInt);

...
{
	public class spInsertCompanyBankInfo
	{
		#region Private Members
		private string sp_Name = "spInsertCompanyBankInfo" ;
		...
		#endregion
		#region Constructor
		public spInsertCompanyBankInfo()
		{
		}
		#endregion
		...
		public int  ExecuteQuery()
		{
			try
			{
				...
				cmd.ExecuteNonQuery();
                return m_CompanyBankInfoID = (int)((IDataParameter)(cmd.Parameters["@CompanyBankInfoID"])).Value;

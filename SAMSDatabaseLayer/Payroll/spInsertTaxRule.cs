...
{
	public class spInsertTaxRule
	{
		#region Private Members
		private string sp_Name = "spInsertTaxRule" ;
		...
		public int  ExecuteQuery()
		{
			try
			{
				...
				cmd.ExecuteNonQuery();
                return m_TaxRuleID = (int)((IDataParameter)(cmd.Parameters["@TaxRuleID"])).Value;

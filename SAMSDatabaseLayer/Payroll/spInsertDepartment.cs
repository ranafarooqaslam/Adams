...
{
	public class spInsertDepartment
    {
        #region Private Members
        private string sp_Name = "spInsertDepartment";
        ...
        public int ExecuteQuery()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                return m_DepartmentID = (int)((IDataParameter)(cmd.Parameters["@DepartmentID"])).Value;

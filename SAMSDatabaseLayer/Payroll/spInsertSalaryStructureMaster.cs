...
{
	public class spInsertSalaryStructureMaster
	{
		#region Private Members
		private string sp_Name = "spInsertSalaryStructureMaster" ;
		...
		#endregion
		#region Constructor
		public spInsertSalaryStructureMaster()
		{
		}
		#endregion
		...
		public int  ExecuteQuery()
		{
			try
			{
				...
				cmd.ExecuteNonQuery();
                return m_SalaryStructureID = (int)((IDataParameter)(cmd.Parameters["@SalaryStructureID"])).Value;
			}
			catch(Exception e)
			{
				throw e;

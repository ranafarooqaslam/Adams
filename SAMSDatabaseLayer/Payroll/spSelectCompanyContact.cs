...
{
	public class spSelectCompanyContact
	{
		#region Private Members
		private string sp_Name = "spSelectCompanyContact" ;
		...
		public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			if(m_CompanyContactID==Constants.IntNullValue)
			{
				parameter.Value = DBNull.Value;
			}
			else
			{
				parameter.Value = m_CompanyContactID;
			}

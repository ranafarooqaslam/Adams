...
{
	public class spInsert_COMPANY
    {
        #region Private Members
        private string sp_Name = "spInsert_COMPANY";
        ...
        public int ExecuteQuery()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                m_COMPANYID = (int)((IDataParameter)(cmd.Parameters["@COMPANYID"])).Value;
                return m_COMPANYID;
            }
            catch (Exception e)
            {

...
{
	public class spGetLeave
	{
		#region Private Members
		private string sp_Name = "spGetLeave" ;
        ...
        private long m_LeaveTransactionsID;
		private bool m_EmployeeIsManager;
		...
		public bool EmployeeIsManager
		{
			set
			{
				m_EmployeeIsManager = value ;
			}
			get
			{
				return m_EmployeeIsManager;
			}
		}
        ...
        public long LeaveTransactionsID
        {
            set { m_LeaveTransactionsID = value; }
            get { return m_LeaveTransactionsID; }
        }
		...
		public spGetLeave()
		{
            m_LeaveTransactionsID = Constants.LongNullValue;
		}
		#endregion
		...
		public void FirstReader(IDataReader dr)
		{
			if(dr.Read())
			{
				...
				m_EmployeeIsManager=Convert.ToBoolean(dr["EmployeeIsManager"]);
		...
		public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
			parameter.ParameterName = "@EmployeeIsManager" ; 
			parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Bit);
				parameter.Value = m_EmployeeIsManager;
			pparams.Add(parameter);
            ...
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.BigInt);
            if (m_LeaveTransactionsID == Constants.LongNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else

...
{
	public class spInsertWorkHoursException
	{
		#region Private Members
		private string sp_Name = "spInsertWorkHoursException" ;
		...
		#endregion
		#region Constructor
		public spInsertWorkHoursException()
		{
		}
		#endregion
		...
		public int  ExecuteQuery()
		{
            try
            {
                ...
                cmd.ExecuteNonQuery();
                return m_ExceptionID = (int)((IDataParameter)(cmd.Parameters["@ExceptionID"])).Value;
            }
            catch (Exception e)
            {
                throw e;

...
{
	public class spInsertSalaryStructureArchiveMaster
	{
        #region Private Members
        private string sp_Name = "spInsertSalaryStructureArchiveMaster";
        ...
        private int m_SalaryStructureArchiveID;
        ...
        public int SalaryStructureArchiveID
        {
            get
            {
                return m_SalaryStructureArchiveID;
            }
        }
        ...
        #endregion
        #region Constructor
        public spInsertSalaryStructureArchiveMaster()
        {
        }
        #endregion
        ...
        public int ExecuteQuery()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
              return  m_SalaryStructureArchiveID = (int)((IDataParameter)(cmd.Parameters["@SalaryStructureArchiveID"])).Value;
        ...
        public void FirstReader(IDataReader dr)
        {
            if (dr.Read())
            {
                ...
                m_SalaryStructureArchiveID = Convert.ToInt32(dr["SalaryStructureArchiveID"]);
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@SalaryStructureArchiveID";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Int);

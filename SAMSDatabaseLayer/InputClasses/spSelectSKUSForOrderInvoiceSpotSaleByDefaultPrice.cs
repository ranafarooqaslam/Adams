...
{
	public class spSelectSKUSForOrderInvoiceSpotSaleByDefaultPrice
	{
		#region Private Members
		private string sp_Name = "spSelectSKUSForOrderInvoiceSpotSaleByDefaultPrice" ;
		...
		#endregion
		#region Constructor
		public spSelectSKUSForOrderInvoiceSpotSaleByDefaultPrice()
		{
		}
		#endregion

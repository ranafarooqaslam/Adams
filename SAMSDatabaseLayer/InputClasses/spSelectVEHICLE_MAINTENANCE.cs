...
namespace SAMSDatabaseLayer.Classes
{
	...
	public class spSelectVEHICLE_MAINTENANCE
	{
		#region Private Members
		private string sp_Name = "spSelectVEHICLE_MAINTENANCE" ;
		...
		public long VEHICLE_MAINTENANCE_ID
		{
			set
			{
				m_VEHICLE_MAINTENANCE_ID = value ;
			}
			get
			{
		...
		#endregion
		#region Constructor
		public spSelectVEHICLE_MAINTENANCE()
		{
            m_DOCUMENT_DATE = Constants.DateNullValue;
            m_LAST_UPDATE = Constants.DateNullValue;
            m_VEHICLE_MAINTENANCE_ID = Constants.LongNullValue;
            m_VEHICLE_ID = Constants.LongNullValue;
            m_IS_DELETED = false;
            m_USER_ID = Constants.LongNullValue;
            m_MAINTENANCE_TYPE = Constants.IntNullValue;
		}
		#endregion
		...
		public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			if(m_VEHICLE_MAINTENANCE_ID==Constants.LongNullValue)
			{
				parameter.Value = DBNull.Value;
			}
			else
			{
				parameter.Value = m_VEHICLE_MAINTENANCE_ID;
			}
			pparams.Add(parameter);

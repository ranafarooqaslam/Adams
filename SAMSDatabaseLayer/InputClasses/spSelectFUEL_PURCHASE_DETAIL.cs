...
{
	public class spSelectFUEL_PURCHASE_DETAIL
	{
		#region Private Members
		private string sp_Name = "spSelectFUEL_PURCHASE_DETAIL" ;
		...
		#endregion
		#region Constructor
		public spSelectFUEL_PURCHASE_DETAIL()
		{
            ...
            m_FUEL_PURCHASE_ID = Constants.LongNullValue;
		}
		#endregion
		...
		public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			if(m_FUEL_PURCHASE_ID==Constants.LongNullValue)
			{
				parameter.Value = DBNull.Value;
			}
			else
			{
				parameter.Value = m_FUEL_PURCHASE_ID;
			}
			pparams.Add(parameter);

...
{
	public class spSelectGL_MASTER2
	{
		#region Private Members
		private string sp_Name = "spSelectGL_MASTER2" ;
		...
		public void FirstReader(IDataReader dr)
		{
			if(dr.Read())
			{
				...
				m_INVOICE_TYPE= Convert.ToInt32(dr["INVOICE_TYPE"]);
				...
				m_INVOICE_ID=Convert.ToInt64(dr["INVOICE_ID"]);

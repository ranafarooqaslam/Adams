...
{
public class spInsertFUEL_ISSUANCE
	{
		#region Private Members
		private string sp_Name = "spInsertFUEL_ISSUANCE" ;
		...
		public long  ExecuteQuery()
		{
			try
			{
				...
				cmd.ExecuteNonQuery();
				m_FUEL_ISSUANCE_ID = (long)((IDataParameter)(cmd.Parameters["@FUEL_ISSUANCE_ID"])).Value;
                return m_FUEL_ISSUANCE_ID;
			}
			catch(Exception e)
			{

...
{
	public class UspSelectPRINCIPALCUSTOMER
	{
		#region Private Members
		private string sp_Name = " UspSelectPRINCIPALCUSTOMER" ;
		...
		#region Constructor
		public UspSelectPRINCIPALCUSTOMER()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspSelectPRINCIPALCUSTOMER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspSelectPRINCIPALCUSTOMER";

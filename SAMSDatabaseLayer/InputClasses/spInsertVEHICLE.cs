...
{
    public class spInsertVEHICLE
    {
        #region Private Members
        private string sp_Name = "spInsertVEHICLE";
        ...
        #endregion
        #region Constructor
        public spInsertVEHICLE()
        {
            TIME_STAMP = Constants.DateNullValue;
            ORDERBOOKER_ID  = Constants.IntNullValue;
            DRIVER_ID  = Constants.IntNullValue;
        ...
        public void FirstReader(IDataReader dr)
        {
            if (dr.Read())
            {
                ...
                m_VEHICLE_ID2 = Convert.ToInt64(dr["VEHICLE_ID2"]);
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@VEHICLE_ID2";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.BigInt);
            if (m_VEHICLE_ID2 == Constants.LongNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_VEHICLE_ID2;
            }
            pparams.Add(parameter);
            ...
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Int);
            if (m_LOADER_ID == Constants.IntNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else

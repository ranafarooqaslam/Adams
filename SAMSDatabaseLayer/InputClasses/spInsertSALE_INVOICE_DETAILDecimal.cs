...
{
    public class spInsertSALE_INVOICE_DETAILDecimal
    {
        #region Private Members
        private string sp_Name = "spInsertSALE_INVOICE_DETAILDecimal";
        private IDbConnection m_connection;
        private IDbTransaction m_transaction;
        private int m_DISTRIBUTOR_ID;
        private int m_SKU_ID;
        private decimal m_QUANTITY_UNIT;
        ...
        #endregion
        #region Constructor
        public spInsertSALE_INVOICE_DETAILDecimal()
        {
        }
        #endregion
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            if (m_QUANTITY_UNIT == Constants.DecimalNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else

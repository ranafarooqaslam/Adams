...
{
	public class uspSelectDistributorInfo
	{
		#region Private Members
		private string sp_Name = " uspSelectDistributorInfo" ;
		...
		#region Constructor
		public uspSelectDistributorInfo()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectDistributorInfo";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectDistributorInfo";

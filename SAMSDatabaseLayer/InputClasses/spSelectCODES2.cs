...
{
	public class spSelectCODES2
	{
		#region Private Members
		private string sp_Name = " spSelectCODES2" ;
		...
		#region Constructor
		public spSelectCODES2()
		{

			m_TIME_STAMP=Constants.DateNullValue;
			m_REF_ID=Constants.IntNullValue;
			m_PARENT_REF_ID=Constants.IntNullValue;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spSelectCODES2";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spSelectCODES2";

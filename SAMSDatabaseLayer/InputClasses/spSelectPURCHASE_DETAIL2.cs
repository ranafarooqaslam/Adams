...
{
	public class spSelectPURCHASE_DETAIL2
	{
        #region Private Members
        private string sp_Name = " spSelectPURCHASE_DETAIL2";
        ...
        #region Constructor
        public spSelectPURCHASE_DETAIL2()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spSelectPURCHASE_DETAIL2";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spSelectPURCHASE_DETAIL2";

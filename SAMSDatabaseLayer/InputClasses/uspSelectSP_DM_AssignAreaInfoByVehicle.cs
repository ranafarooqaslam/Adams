...
{
	public class uspSelectSP_DM_AssignAreaInfoByVehicle
	{
		#region Private Members
		private string sp_Name = "uspSelectSP_DM_AssignAreaInfoByVehicle" ;
		...
		public void FirstReader(IDataReader dr)
		{
			if(dr.Read())
			{
				...
				m_VehicleID=Convert.ToInt64(dr["VehicleID"]);
			}
		}
		public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			if(m_VehicleID==Constants.LongNullValue)
			{
				parameter.Value = DBNull.Value;
			}
			else
			{
				parameter.Value = m_VehicleID;
			}
			pparams.Add(parameter);

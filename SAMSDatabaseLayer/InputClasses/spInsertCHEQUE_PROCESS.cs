...
{
    public class spInsertCHEQUE_PROCESS
    {
        #region Private Members
        private string sp_Name = " spInsertCHEQUE_PROCESS";
        ...
        private int m_ACCONT_HEAD_ID_HO;
        //
        ...
        public int ACCONT_HEAD_ID_HO
        {
            set { m_ACCONT_HEAD_ID_HO = value; }
            get { return m_ACCONT_HEAD_ID_HO; }
        }
        ...
        public string  ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spInsertCHEQUE_PROCESS";
                ...
                cmd.ExecuteNonQuery();
                m_CHEQUE_PROCESS_ID = (long)((IDataParameter)(cmd.Parameters["@CHEQUE_PROCESS_ID"])).Value;
                return m_CHEQUE_PROCESS_ID.ToString();
            }
            catch (Exception e)
            {
                throw e;
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spInsertCHEQUE_PROCESS";
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@ACCONT_HEAD_ID_HO";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.BigInt);
            if (m_ACCONT_HEAD_ID_HO == Constants.IntNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_ACCONT_HEAD_ID_HO;
            }
            pparams.Add(parameter);

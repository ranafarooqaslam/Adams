...
{
    public class spInsertSALE_ORDER_DETAIL
    {
        #region Private Members
        private string sp_Name = " spInsertSALE_ORDER_DETAIL";
        ...
        #region Constructor
        public spInsertSALE_ORDER_DETAIL()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spInsertSALE_ORDER_DETAIL";
                ...
                cmd.ExecuteNonQuery();
                m_SALE_ORDER_DETAIL_ID = (long)((IDataParameter)(cmd.Parameters["@SALE_ORDER_DETAIL_ID"])).Value;
                return true;
            }
            catch (Exception e)
            {
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spInsertSALE_ORDER_DETAIL";

...
{
	public class spUpdateSALE_ORDER_MASTER
	{
        #region Private Members
        private string sp_Name = "spUpdateSALE_ORDER_MASTER";
        ...
        #endregion
        #region Constructor
        public spUpdateSALE_ORDER_MASTER()
        {
        ...
        public void FirstReader(IDataReader dr)
        {
            if (dr.Read())
            {
                ...
                m_PO_DATE = Convert.ToDateTime(dr["PO_DATE"]);
                ...
                m_MANUAL_ORDER_ID = Convert.ToString(dr["MANUAL_ORDER_ID"]);
                m_DC_PO_NO = Convert.ToString(dr["DC_PO_NO"]);
            }
        }

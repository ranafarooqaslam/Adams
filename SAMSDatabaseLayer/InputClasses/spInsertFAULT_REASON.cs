...
{
	public class spInsertFAULT_REASON
	{
		#region Private Members
		private string sp_Name = "spInsertFAULT_REASON" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.ExecuteNonQuery();
				m_FAULT_ID = (int)((IDataParameter)(cmd.Parameters["@FAULT_ID"])).Value;
				return true;
			}
			catch(Exception e)
			{

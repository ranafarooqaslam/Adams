...
{
	public class UspUpdatePurchaseDetailStockTransforOut
	{
		#region Private Members
		private string sp_Name = "UspUpdatePurchaseDetailStockTransforOut" ;
		...
		#endregion
		#region Constructor
		public UspUpdatePurchaseDetailStockTransforOut()
		{

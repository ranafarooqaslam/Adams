...
{
    public class spSelectACCOUNT_HEAD_HO
    {
        #region Private Members
        private string sp_Name = " spSelectACCOUNT_HEAD_HO";
        ...
        #region Constructor
        public spSelectACCOUNT_HEAD_HO()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spSelectACCOUNT_HEAD_HO";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spSelectACCOUNT_HEAD_HO";

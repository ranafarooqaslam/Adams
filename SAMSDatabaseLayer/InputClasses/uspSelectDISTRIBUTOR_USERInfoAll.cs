...
{
	public class uspSelectDISTRIBUTOR_USERInfoAll
	{
		#region Private Members
		private string sp_Name = " uspSelectDISTRIBUTOR_USERInfoAll" ;
		...
		#region Constructor
		public uspSelectDISTRIBUTOR_USERInfoAll()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspSelectDISTRIBUTOR_USERInfoAll";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspSelectDISTRIBUTOR_USERInfoAll";

...
{
	public class spUpdateLOADPASS_MASTER
	{
        #region Private Members
        private string sp_Name = "spUpdateLOADPASS_MASTER";
        ...
        #endregion
        #region Constructor
        public spUpdateLOADPASS_MASTER()
        {
            m_DISTRIBUTOR_ID = Constants.IntNullValue;
            m_PRINCIPAL_ID = Constants.IntNullValue;
            m_DELIVERY_MAN_ID = Constants.IntNullValue;
            m_USER_ID = Constants.IntNullValue;
            m_IS_ACTIVE = true;
            m_LOADPASS_ID = Constants.LongNullValue;

...
{
    public class spInsertDISTRIBUTOR_ASSIGNMENT2
    {
        #region Private Members
        private string sp_Name = "spInsertDISTRIBUTOR_ASSIGNMENT2";
        ...
        #region Constructor
        public spInsertDISTRIBUTOR_ASSIGNMENT2()
        {
            m_COMPANY_ID = Constants.IntNullValue;
            m_DISTRIBUTOR_TYPE_ID = Constants.IntNullValue;
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spInsertDISTRIBUTOR_ASSIGNMENT2";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spInsertDISTRIBUTOR_ASSIGNMENT2";

...
{
	public class spUpdatePURCHASE_MASTER
	{
		#region Private Members
		private string sp_Name = " spUpdatePURCHASE_MASTER" ;
		...
		#region Constructor
		public spUpdatePURCHASE_MASTER()
		{
		...
		m_ORDER_NUMBER = null;
		m_BUILTY_NO = null;
        m_DESPATCH_DATE = Constants.DateNullValue;
        m_DESPATCH_NO = null;
        m_SEAL_NO = null;
        m_GATEPASS_NO = null;
        m_DRIVER_NAME = null;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "spUpdatePURCHASE_MASTER";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "spUpdatePURCHASE_MASTER";

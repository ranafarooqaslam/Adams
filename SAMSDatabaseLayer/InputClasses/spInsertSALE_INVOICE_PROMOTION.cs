...
{
    public class spInsertSALE_INVOICE_PROMOTION
    {
        #region Private Members
        private string sp_Name = " spInsertSALE_INVOICE_PROMOTION";
        ...
        #region Constructor
        public spInsertSALE_INVOICE_PROMOTION()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spInsertSALE_INVOICE_PROMOTION";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spInsertSALE_INVOICE_PROMOTION";

...
{
    public class spDeleteDISTRIBUTOR_ASSIGNMENT2
    {
        #region Private Members
        private string sp_Name = " spDeleteDISTRIBUTOR_ASSIGNMENT2";
        ...
        #region Constructor
        public spDeleteDISTRIBUTOR_ASSIGNMENT2()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "spDeleteDISTRIBUTOR_ASSIGNMENT2";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "spDeleteDISTRIBUTOR_ASSIGNMENT2";

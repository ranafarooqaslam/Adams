...
{
	public class spSELECT_Salary_Slip_Loan_Installment
	{
		#region Private Members
		private string sp_Name = "spSELECT_Salary_Slip_Loan_Installment" ;
		private IDbConnection m_connection;
		private IDbTransaction m_transaction;
		private int m_COMMPANY_ID;
		private int m_LOCATIONID;
		private int m_DEPARTMENTID;
		private int m_SALAR_BEHAVIOR;
		...
		public int SALAR_BEHAVIOR
		{
			set
			{
				m_SALAR_BEHAVIOR = value ;
			}
			get
			{
				return m_SALAR_BEHAVIOR;
			}
		}
		...
		#endregion
		#region Constructor
		public spSELECT_Salary_Slip_Loan_Installment()
		{
		}
		#endregion
		...
		public void FirstReader(IDataReader dr)
		{
			if(dr.Read())
			{
				...
				m_SALAR_BEHAVIOR= Convert.ToInt32(dr["SALAR_BEHAVIOR"]);
		...
		public void GetParameterCollection(ref IDbCommand cmd)
		{
			...
			parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
			parameter.ParameterName = "@SALAR_BEHAVIOR" ; 
			parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Int);
			if(m_SALAR_BEHAVIOR==Constants.IntNullValue)
			{
				parameter.Value = DBNull.Value;
			}
			else
			{
				parameter.Value = m_SALAR_BEHAVIOR;
			}
			pparams.Add(parameter);

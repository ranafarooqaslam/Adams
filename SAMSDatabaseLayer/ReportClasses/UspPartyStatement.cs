...
{
	public class UspPartyStatement
	{
		#region Private Members
		private string sp_Name = " UspPartyStatement" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspPartyStatement";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspPartyStatement";

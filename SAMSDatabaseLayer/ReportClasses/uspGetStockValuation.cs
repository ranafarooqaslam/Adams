...
{
	public class uspGetStockValuation
	{
		#region Private Members
		private string sp_Name = " uspGetStockValuation" ;
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspGetStockValuation";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspGetStockValuation";

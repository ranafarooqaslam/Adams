...
{
    public class UspTownWiseSaleReport
    {
        #region Private Members
        private string sp_Name = " UspTownWiseSaleReport";
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "UspTownWiseSaleReport";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "UspTownWiseSaleReport";

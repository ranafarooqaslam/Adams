...
{
	public class UspDocumentPrinting
	{
		#region Private Members

		private string sp_Name = " UspDocumentPrinting" ;
        ...
        public UspDocumentPrinting()
        {
            ...
            m_IS_REGISTERED = Constants.IntNullValue;
        ...
        public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "UspDocumentPrinting";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "UspDocumentPrinting";
		...
		public void FirstReader(IDataReader dr)
			{
				if(dr.Read())
				{
                    ...
                    m_IS_REGISTERED = Convert.ToInt32(dr["IS_REGISTERED"]);
                    m_CUSTOMER_ID = Convert.ToInt32(dr["CUSTOMER_ID"]);
                    m_ROUTE_ID = Convert.ToInt32(dr["ROUTE_ID"]);
                    m_PRINTTYPE = Convert.ToInt32(dr["PRINTTYPE"]);
				}
			}
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
			...
			parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Int);
            if (m_IS_REGISTERED == Constants.IntNullValue)
			{
				parameter.Value = DBNull.Value;
			}
			else
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@PRINTTYPE";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Int);
            if (m_PRINTTYPE == Constants.IntNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else

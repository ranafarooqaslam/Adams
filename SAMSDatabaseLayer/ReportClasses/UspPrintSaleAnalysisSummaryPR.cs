...
{
    public class UspPrintSaleAnalysisSummaryPR
    {
        #region Private Members
        private string sp_Name = " UspPrintSaleAnalysisSummaryPR";
        ...
        {
            set { m_DISTRIBUTOR_TYPE_ID = value; }
            get { return m_DISTRIBUTOR_TYPE_ID; }
        }
        ...
        #region Constructor
        public UspPrintSaleAnalysisSummaryPR()
        {
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "UspPrintSaleAnalysisSummaryPR";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "UspPrintSaleAnalysisSummaryPR";
        ...
        public void FirstReader(IDataReader dr)
        {
            if (dr.Read())
            {
                m_DATETYPE = Convert.ToByte(dr["DATETYPE"]);
                m_COLUMN = Convert.ToByte(dr["COLUMN"]);

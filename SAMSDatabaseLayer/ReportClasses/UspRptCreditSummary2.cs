...
{
    public class UspRptCreditSummary2
    {
        #region Private Members
        private string sp_Name = " UspRptCreditSummary2";
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "UspRptCreditSummary2";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "UspRptCreditSummary2";

...
{
    public class RptInvoiceWiseSalesmenRecovery
    {
        #region Private Members
        private string sp_Name = "RptInvoiceWiseSalesmenRecovery";
        ...
        public int ISREGISTER_ID
        {
            set
            {
                m_ISREGISTER_ID = value;
            }
            get
            {
                return m_ISREGISTER_ID;
            }
        }
        ...
        #endregion
        #region Constructor
        public RptInvoiceWiseSalesmenRecovery()
        {
        }
        #endregion
        ...
        public void FirstReader(IDataReader dr)
        {
            if (dr.Read())
            {
                ...
                m_ISREGISTER_ID = Convert.ToInt32(dr["ISREGISTER_ID"]);
        ...
        public void GetParameterCollection(ref IDbCommand cmd)
        {
            ...
            parameter = ProviderFactory.GetParameter(EnumProviders.SQLClient);
            parameter.ParameterName = "@ISREGISTER_ID";
            parameter.DbType = ProviderFactory.GetDBType(EnumProviders.SQLClient, EnumDBTypes.Int);
            if (m_ISREGISTER_ID == Constants.IntNullValue)
            {
                parameter.Value = DBNull.Value;
            }
            else
            {
                parameter.Value = m_ISREGISTER_ID;
            }
            pparams.Add(parameter);

...
{
	public class uspPrintSALE_ORDER_PROMOTION
	{
		#region Private Members
		private string sp_Name = " uspPrintSALE_ORDER_PROMOTION" ;
		...
		#region Constructor
		public uspPrintSALE_ORDER_PROMOTION()
		{
		...
		public bool  ExecuteQuery()
		{
			try
			{
				...
				cmd.CommandText = "uspPrintSALE_ORDER_PROMOTION";
		...
		public IDataReader ExecuteReader()
		{
			try
			{
				...
				command.CommandText = "uspPrintSALE_ORDER_PROMOTION";

...
{
    public class UspRptCreditSummary
    {
        #region Private Members
        private string sp_Name = " UspRptCreditSummary";
        ...
        public bool ExecuteQuery()
        {
            try
            {
                ...
                cmd.CommandText = "UspRptCreditSummary";
        ...
        public IDataReader ExecuteReader()
        {
            try
            {
                ...
                command.CommandText = "UspRptCreditSummary";

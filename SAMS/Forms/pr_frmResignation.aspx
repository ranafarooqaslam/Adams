<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="pr_frmResignation.aspx.cs" Inherits="pr_frmResignation" Title="Resignation" %>
        ...
        <ContentTemplate>
            ...
            <div>
                        ...
                        <td>
                            <table width="100%">
                                ...
                                <td style="width:30px;">
                                        ...
                                        <td>
                                         <cc1:CalendarExtender ID="txtResignDate_CalendarExtender" runat="server" TargetControlID="txtResignDate" PopupButtonID="txtResignDate" Format="dd-MMM-yyyy"></cc1:CalendarExtender>
                                           <asp:TextBox ID="txtResignDate" runat="server" Width="200px"></asp:TextBox>
                                        </td>
                                </tr>
                                    <tr>
                                    <td></td>
                                        ...
                                        <td width="30%">
                                         <asp:TextBox ID="txtReason" runat="server" TextMode="MultiLine" Width="473px" Height="50px"></asp:TextBox>
                                        </td>
                                        <td width="10%">
                ...
                <asp:Panel ID="pnlAdvanceGrid" runat="server">
                    <asp:LinkButton ID="btnShowpnAdvanceContent" OnClick="btnShowpnAdvanceContent_Click" runat="server">Add New Resignation</asp:LinkButton>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                             ...
                             <td>
                                 <%# Eval("RESIGNATION_Date")%>                                  
                            </td>                               
                             <td>
                                <asp:LinkButton ID="btnEditAssets" CommandArgument='<%# Eval("Resignation_ID")%>' CommandName="edit"
                                    runat="server" ClientIDMode="AutoID">
                                    Edit
                                </asp:LinkButton>
                            </td>
                            <td>
                                <asp:LinkButton ID="btnDeleteAssets" CommandName="delete" CommandArgument='<%# Eval("Resignation_ID")%>'  runat="server" ClientIDMode="AutoID" OnClientClick="javascript:return confirm('Are you sure you want to Delete?');return false;">
                                            Delete
                                </asp:LinkButton>
                            </td>                       
                        </tr>

...
public partial class Forms_RptStockReconcilation : System.Web.UI.Page
{
    ...
    protected void btnViewPDF_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = RptInventoryCtl.SelectPrincipalStockReconcilation(int.Parse(drpDistributor.SelectedValue.ToString()),
        int.Parse(DrpPrincipal.SelectedValue.ToString()),DateTime.Parse(txtStartDate.Text),DateTime.Parse(txtEndDate.Text),
        int.Parse(this.Session["UserId"].ToString()),ddlType.SelectedIndex,Convert.ToInt32(rblRate.SelectedValue));
    ...
    protected void btnViewExcel_Click(object sender, EventArgs e)
    {
        ...
        //    SAMSBusinessLayer.Reports.StockReConsilation CrpReport = new SAMSBusinessLayer.Reports.StockReConsilation();
        //    DataTable dt = mController.SelectReportTitle(int.Parse(drpDistributor.SelectedValue.ToString()));
        //    DataSet ds = RptInventoryCtl.SelectPrincipalStockReconcilation(int.Parse(drpDistributor.SelectedValue.ToString()), int.Parse(DrpPrincipal.SelectedValue.ToString()), DateTime.Parse(txtStartDate.Text), DateTime.Parse(txtEndDate.Text), int.Parse(this.Session["UserId"].ToString()),ddlType.SelectedIndex,Convert.ToInt32(rblRate.SelectedValue));
        //    CrpReport.SetDataSource(ds);
        //    CrpReport.Refresh();
        ...
        DataTable dt = mController.SelectReportTitle(int.Parse(drpDistributor.SelectedValue.ToString()));
        DataSet ds =
            RptInventoryCtl.SelectPrincipalStockReconcilation(int.Parse(drpDistributor.SelectedValue.ToString()),

<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="frmAssetCustomerReturn.aspx.cs" Inherits="Forms_frmAssetCustomerReturn" Title="SAMS :: Customer Asset Return" %>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            <td align="left">
                                                <strong>
                                                    <asp:Label ID="Label5" runat="server" Width="80px" Height="13px" Text="Return Date"></asp:Label></strong>
                                            </td>
...
<%--                                                                style="display:inline-block;color:White;background-color:#006699;font-weight:bold;height:16px;width:250px;"--%>
                                                            ...
                                                            <asp:BoundField DataField="CompanyAssetNo" ReadOnly="true" HeaderText="Company Asset No">
                                                             ...
                                                             <asp:BoundField DataField="FROM_LOCATION" ReadOnly="true" HeaderText="FROM_LOCATION">
                                                                <HeaderStyle CssClass="HidePanel" />
                                                                <ItemStyle CssClass="HidePanel" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="Transfer_Date" ReadOnly="true" HeaderText="Transfer Date">
                                                                <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="2px" HorizontalAlign="Right"
                                                                    Width="85px" />
                                                            </asp:BoundField>

...
/// </summary>
public partial class Forms_RptSalesmanWiseFuelExpense : System.Web.UI.Page
{
    /// <summary>
    /// Page_Load Function
    /// </summary>
    ...
    private void ShowReport(int ReportType)
    {
        ...
        ds = RptAccountCtl.GetFuelExpense(Convert.ToInt32(drpDistributor.SelectedValue), Convert.ToInt32(ddlVehicle.SelectedValue), Convert.ToInt32(ddlSalesman.SelectedValue),
            Convert.ToInt32(DrpFuelType.SelectedValue),DateTime.Parse(txtStartDate.Text + " 00:00:00"), DateTime.Parse(txtEndDate.Text + " 23:59:59"),Convert.ToInt32(rblViewType.SelectedValue));
        ...
        {
            CrpReport = new SAMSBusinessLayer.Reports.CrpFuelExpenseSummary();
        }
        else
        {
            CrpReport = new SAMSBusinessLayer.Reports.CrpFuelExpenseDetail();
        }
        ...
        CrpReport.SetParameterValue("FuelType", DrpFuelType.SelectedItem.Text);

<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="frmSalePersonDOR.aspx.cs" Inherits="Forms_frmSalePersonDOR" Title="SAMS :: Sale Person DOR" %>
                        ...
                        <ContentTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <strong>
                                            <asp:Label ID="Label1" runat="server" Text="DOR" Width="82px"></asp:Label></strong>
                                    </td>
                                    <td align="left">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="height: 25px">
                                        <asp:DropDownList ID="DrpSaleForceType" runat="server" Width="200px" CssClass="DropList">

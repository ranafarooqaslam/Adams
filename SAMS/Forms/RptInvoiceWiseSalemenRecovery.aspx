...
CodeFile="RptInvoiceWiseSalemenRecovery.aspx.cs" Inherits="Forms_RptInvoiceWiseSalemenRecovery" %>
                                     ...
                                     <tr>
                                            ...
                                            <td style="height: 25px" align="left">
                                                <asp:DropDownList ID="DrpDocumentType" runat="server" Width="200px" CssClass="DropList">
                                                    <asp:ListItem Value="0">Cash Realization</asp:ListItem>
                                                    <asp:ListItem Value="1">Cheque Realization</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="left">
                                                                    ...
                                                                    AutoPostBack="true" OnSelectedIndexChanged="rblCustomerType_SelectedIndexChanged">

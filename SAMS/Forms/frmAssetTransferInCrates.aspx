<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="frmAssetTransferInCrates.aspx.cs" Inherits="Forms_frmAssetTransferInCrates" Title="SAMS :: Asset Transfer In" %>
...
<script type="text/javascript" src="../AjaxLibrary/jquery.searchabledropdown-1.0.8.min.js"></script>
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function CreatePopup() {
            return confirm("Once saved you can't modify the records. Do you want to Continue?");
        }
    </script>
    <div id="right_data">
        <div>
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td align="left">
                                                <strong>
                                                    <asp:Label ID="Label5" runat="server" Width="80px" Height="13px" Text="Transfer In Date"></asp:Label></strong>
                                            </td>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                            <ContentTemplate>
                                                ...
                                                <asp:Panel ID="Panel2" runat="server" Width="750px" Height="250px" ScrollBars="Vertical"
                                                    ...
                                                    <asp:GridView ID="GridAssetType" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="Transfer_Date" ReadOnly="true" HeaderText="Transfer Out Date">
                                                                <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="2px" HorizontalAlign="Right"
                                                                    Width="85px" />
                                                            </asp:BoundField>
                                                            <asp:BoundField DataField="TYPE_ID" ReadOnly="true" HeaderText="TYPE_ID">
                                                                 <HeaderStyle CssClass="HidePanel" />
                                                                <ItemStyle CssClass="HidePanel" />
                                                            </asp:BoundField>
                                ...
                                <asp:Button AccessKey="S" ID="btnSaveDocument" runat="server" Width="119px" Font-Size="8pt"
                                    Text="Transfer In"  OnClick="btnSaveDocument_Click" CssClass="Button" OnClientClick="return CreatePopup();" />

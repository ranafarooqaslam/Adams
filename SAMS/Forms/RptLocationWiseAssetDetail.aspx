<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptLocationWiseAssetDetail.aspx.cs" Inherits="Forms_RptLocationWiseAssetDetail" Title="SAMS :: Location Wise Detail" %>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            <td align="left">
                                                <strong>
                                                <asp:Label ID="Label1" runat="server" Width="94px" Text="Document Type" CssClass="lblbox"></asp:Label></strong>
                                            </td>
                                            <td style="width: 238px; height: 25px" align="left">
                                                <asp:DropDownList ID="drpDocumentType" runat="server" Width="200px" AutoPostBack="true"
                                                     CssClass="DropList" OnSelectedIndexChanged="drpDocumentType_SelectedIndexChanged">
                                                <asp:ListItem Text="Location Wise Detail" Value="0"></asp:ListItem>
                                                <asp:ListItem Text="Region Wise Summary" Value="1"></asp:ListItem>
                                                <asp:ListItem Text="Region Wise Detail" Value="2"></asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        ...
                                        <tr runat="server" id="regRow">
                                            <td style="height: 25px;" align="left">
                                                <strong>
                                                    <asp:Label ID="Label11" runat="server" Width="56px" Text="Region" CssClass="lblbox"></asp:Label></strong>
                                            </td>
                                            <td align="left">
                                                <asp:DropDownList ID="ddlRegion" runat="server" Width="200px" CssClass="DropList">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                         ...
                                         <tr>
                                            <td align="left">
                                                <strong>
                                                    <asp:Label ID="Label5" runat="server" Width="80px" Height="13px" Text="As On Date"></asp:Label></strong>
                                            </td>

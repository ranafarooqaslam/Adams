...
public partial class pr_rptAttendanceSummary : System.Web.UI.Page
{
    ...
    protected void ShowReport(int ReportType)
    {
        try
        {
            ...
            dtAttendance = AC.GetAttendanceSummary(Convert.ToInt32(ddlLocation.SelectedValue), Convert.ToInt32(ddlDepartment.SelectedValue), Convert.ToInt32(ddlEmployee.SelectedValue), dtFrom, dtTo);

            SAMSBusinessLayer.Reports.PayrollReports.CrpAttendanceSummary CrpReport = new SAMSBusinessLayer.Reports.PayrollReports.CrpAttendanceSummary();

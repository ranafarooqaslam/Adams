<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptCustomerWiseSale.aspx.cs" Inherits="Forms_RptCustomerWiseSale" Title="SAMS :: Customer Wise Sale" %>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 81px" align="left">
                                            <strong>
                                                <asp:Label ID="Label1" runat="server" Width="80px" Text="No. Of Customer" CssClass="lblbox"></asp:Label></strong>
                                        </td>
                                        <td align="left">
                                        </td>
                                        <td style="height: 25px" align="left">
                                            <asp:TextBox ID="txtNoOfCustomer" runat="server" Width="200px" CssClass="form-control" FilterType="Numbers">
                                            </asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>

<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="frmAssetTransferOutCrates.aspx.cs" Inherits="Forms_frmAssetTransferOutCrates" Title="SAMS :: Asset Transfer Out" %>
                                         ...
                                         <tr>
                                            ...
                                            <td style="height: 25px;display:none;">
                                                 <asp:CheckBox ID="chkSerial" runat="server" Width="150px" Text="Is Serial No. based" AutoPostBack="True"
                                                    Checked="false" OnCheckedChanged="chkSerial_CheckChanged"></asp:CheckBox>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        <div>
            ...
            <table width="100%">
                 <td>
                        <table>
                            <tbody>
                <tr runat="server" id="nonSerialBasedRow" visible="true">
                    <td>
                        <strong>
                ...
                <tr runat="server" id="nonSerialGridView" visible="true">
                    <td>
                        <table>
                            <tbody>
                                <tr>
                ...
                <tr runat="server" id="serialBasedRow" visible="false">
                    <td>
                        <table>
                            <tbody>
                                <tr>

...
public partial class pr_rptSalarySlipStaff : System.Web.UI.Page
{
    ...
    protected void ShowReport(int ReportType)
    {
        try
        {
            ...
            dsSlip = ppc.GetPaySlipStaff(Convert.ToInt32(Session["WorkingCompanyID"]), Convert.ToInt64(ddlEmployee.SelectedValue), Convert.ToInt32(ddlLocation.SelectedValue), Convert.ToInt32(ddlDepartment.SelectedValue), dtFrom, Convert.ToDateTime(dtTo.ToShortDateString() + " 23:59:59"),1);
            ...
            SAMSBusinessLayer.Reports.PayrollReports.CrpSalarySlipStaff CrpReport = new SAMSBusinessLayer.Reports.PayrollReports.CrpSalarySlipStaff();
            srAllownces = CrpReport.OpenSubreport("srAllownces");
            srDeduction = CrpReport.OpenSubreport("srDeductions");

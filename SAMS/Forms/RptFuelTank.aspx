<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptFuelTank.aspx.cs" Inherits="Forms_RptFuelTank" Title="SAMS :: Fuel Tank Report" %>
                            ...
                            <table>                                
                                <tr>
                                    ...
                                    <td style="height: 25px" align="left">
                                        <asp:CheckBox ID="cbDetail" runat="server" Text="With Vehicle Detail" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left">
                                    ...
                                    <td align="left">
                                        <strong>
                                            <asp:Label ID="Label2" runat="server" Text="Fuel Type" Width="73px"></asp:Label></strong>
                                    </td>
                                    <td align="left">
                                    </td>
                                    <td style="height: 25px" align="left">
                                        <asp:RadioButtonList ID="rblDataType" runat="server" RepeatDirection="Horizontal" Width="200px">
                                            <asp:ListItem Value="1" Text="Petrol" Selected="True"></asp:ListItem>

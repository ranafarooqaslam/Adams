<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptVehiclLogBook.aspx.cs" Inherits="Forms_RptVehiclLogBook" Title="SAMS :: Vehicle Log Book Report" %>
                        ...
                        <ContentTemplate>
                            <table>                                
                                ...
                                <tr>
                                    ...
                                    <td style="height: 25px" align="left">
                                        <asp:RadioButtonList ID="rblDataType" runat="server" RepeatDirection="Horizontal" Width="250px">
                                            <asp:ListItem Value="0" Text="Both" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="1" Text="Fueling"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="Maintenance"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    </td>
                                </tr>
                                <tr>

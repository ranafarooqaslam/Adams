<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptSaleTradeChannel.aspx.cs" Inherits="Forms_RptSaleTradeChannel" Title="SAMS :: Trade Channel Sale" %>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <strong>
                                                <asp:Label ID="Label1" runat="server" Width="103px" Text="Report Type" CssClass="lblbox"></asp:Label></strong>
                                        </td>
                                        <td align="left">
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 1px; height: 2px" align="left">
                                            <strong>
                                                <asp:Label ID="Label2" runat="server" Width="48px" Text="Catagory" CssClass="lblbox"></asp:Label></strong>
                                        </td>
                                        <td style="height: 2px" align="left">
                                        </td>
                                        ...
                                        <td style="width: 1px; height: 2px" align="left">
                                        <strong>
                                                <asp:Label ID="lblSkus" runat="server" Width="48px" Text="Skus" CssClass="lblbox"></asp:Label></strong>
                                                <asp:CheckBox ID="ChbAllSkus" runat="server" Text="All Skus" AutoPostBack="True"
                                                OnCheckedChanged="ChbAllSkus_CheckedChanged"></asp:CheckBox>
                                                 </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 2px" align="left">
                                        ...
                                        <td style="height: 2px" align="left" colspan="3">
                                            <asp:Panel ID="Panel1" runat="server" Width="295px" Height="150px" ScrollBars="Vertical"
                                                ...
                                                <asp:CheckBoxList ID="ListCatagory" runat="server" OnSelectedIndexChanged="ListCatagory_SelectedIndexChanged" AutoPostBack="true" >
                                                </asp:CheckBoxList>
                                            </asp:Panel>
                                        </td>
                                        <td style="width: 1px; height: 2px" align="left">
                                          <asp:Panel ID="Panel2" runat="server" Width="295px" Height="150px" ScrollBars="Vertical"
                                                BorderStyle="Groove" BorderWidth="1px">
                                                <asp:CheckBoxList ID="ListSkus" runat="server" AutoPostBack="True">
                                                </asp:CheckBoxList>
                                            </asp:Panel>
                                        </td>
                                    </tr>

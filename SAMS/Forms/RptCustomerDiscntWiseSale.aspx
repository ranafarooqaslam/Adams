<%@ Page Title="SAMS :: Client Wise Discount Wise Sale" Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true" 
CodeFile="RptCustomerDiscntWiseSale.aspx.cs" Inherits="Forms_RptCustomerDiscntWiseSale" %>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                     <td style="width: 95px" align="left">
                                            <strong>
                                                <asp:Label ID="Label1" runat="server" Width="70px" Text="Report Type" CssClass="lblbox"></asp:Label></strong>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 25px" align="left">
                                            <asp:DropDownList ID="drpDistributor" runat="server" Width="200px" CssClass="DropList"  AutoPostBack="True" OnSelectedIndexChanged="drpDistributor_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>

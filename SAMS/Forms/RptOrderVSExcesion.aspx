<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="RptOrderVSExcesion.aspx.cs" Inherits="Forms_RptOrderVSExcesion" Title="SAMS :: Order VS Dispatch" %>
                        ...
                        <ContentTemplate>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <strong>
                                            <asp:Label ID="Label1" runat="server" Height="13px" Text="Report Type" Width="70px"></asp:Label></strong>
                                    </td>
                                    <td align="left">
                                    </td>
                                    <td align="left" style="height: 25px">

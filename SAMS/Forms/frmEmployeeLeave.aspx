<%@ Page Language="C#" MasterPageFile="~/Forms/AppMaster.master" AutoEventWireup="true" CodeFile="frmEmployeeLeave.aspx.cs" Inherits="Forms_frmEmployeeLeave" Title="Untitled Page" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="mainCopy">
    <div class="container" style="background-color: white">
        ...
        function CalDate()
        {
            var str  = document.getElementById("<%= txtdays.ClientID %>").value;
        
            if(str == null || str.length == 0)
		    {
                var d1  = document.getElementById("<%= txtStartDate.ClientID %>").value;
                var d2  = document.getElementById("<%= txtEndDate.ClientID %>").value;
                d1 = d1.split("/");
                d2 = d2.split("/");
                var sDate = new Date(d1[1]+"/"+d1[0]+"/"+d1[2]);
                var eDate = new Date(d2[1]+"/"+d2[0]+"/"+d2[2]);

                var t2 = eDate.getTime();
                var t1 = sDate.getTime();
 
                document.getElementById("<%= txtdays.ClientID %>").value = parseInt((t2-t1)/(24*3600*1000)) + 1;
            }
                        ...
                        <ContentTemplate>
                            <table style="width: 43%">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="height: 25px">
                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="txtBox " Width="193px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td align="left" style="height: 25px">
                                        <asp:Label ID="Label24" runat="server" Text="Leave Type" Width="91px"></asp:Label></td>
                                    <td align="left" style="height: 25px"><asp:RadioButtonList ID="RbdDaysType" runat="server" Width="157px" RepeatDirection="Horizontal" OnSelectedIndexChanged="RbdDaysType_SelectedIndexChanged" AutoPostBack="True">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="height: 25px">
                                        <asp:DropDownList ID="DrpLeaveType" runat="server" CssClass="DropList" Width="200px">
                                            ...
                                            <asp:ListItem Value="591">Withoutpay</asp:ListItem>
                                        </asp:DropDownList></td>
                                </tr>
                                <tr>
                                    <td align="left" style="height: 25px">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="height: 25px">
                                        <asp:TextBox ID="txtEndDate" runat="server" CssClass="txtBox " MaxLength="10" Width="167px"></asp:TextBox>&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="height: 25px">
                                        <asp:Label ID="Label7" runat="server" Height="13px" Text="Days" Width="51px"></asp:Label></td>
                                    <td align="left" style="height: 25px">

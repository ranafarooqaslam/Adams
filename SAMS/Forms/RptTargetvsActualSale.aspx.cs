...
/// </summary>
public partial class Forms_RptTargetvsActualSale : System.Web.UI.Page
{
    /// <summary>
    /// Page_Load Function
    /// </summary>
    ...
    protected void ShowReport(int type)
    {
        ...
        SAMSBusinessLayer.Reports.CrpTargetvsActualSale CrpReport = new SAMSBusinessLayer.Reports.CrpTargetvsActualSale();
        ...
        DataSet ds = RptSaleCtl.SelectTargetvsActualSale(sbDistributorId.ToString(),
            startDate, endDate);

<%@ Page Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true"
    CodeFile="frmRetStockReceived.aspx.cs" Inherits="frmRetStockReceived" Title="SAMS :: Stock Received" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="cphPage">
    ...
    <script language="JavaScript" type="text/javascript">
        ...
        function Calculate() {
            var rcvd = document.getElementById('<%=txtReceivedQty.ClientID%>').value;
            var rjct = document.getElementById('<%=txtRejectedQty.ClientID%>').value;
            if (parseInt(rcvd)) {
                rcvd = parseInt(rcvd);
            }
            else {
            ...
            var qty = parseInt(rcvd) - parseInt(rjct);
        ...
        function ValidateForm() {
            ...
            str = document.getElementById('<%=txtReceivedQty.ClientID%>').value;
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 5%"></td>
                                          <td style="width: 10%">
                                            <strong>
                                                <asp:Label ID="lblAccountHead" runat="server" Height="14px" Text="Account Head" Width="98px" Visible="false" CssClass="auto-style1"></asp:Label>
                                            </strong>
                                        </td>
                                        <td style="width: 45%">
                                    ...
                                    <tr>
                                        <td style="width: 10%">
                                            <strong>
                                                <asp:Label ID="Label4" runat="server" Text="Transfer To" Visible="False" Width="99px"></asp:Label>
                                            </strong>
                                        </td>
                                        <td style="width: 25%">
                                    ...
                                    <tr>
                                        <td style="width: 10%">
                                            <strong>
                                                <asp:Label ID="Label1" runat="server" CssClass="lblbox" Text="Document  No" Width="94px"></asp:Label>
                                            </strong>
                                        </td>
                                        <td style="width: 25%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 25%">
                                            <asp:CheckBox ID="ChbFreeSKU" runat="server" Width="121px" Text="Apply Free SKU"
                                                AutoPostBack="True" Visible="false" OnCheckedChanged="ChbFreeSKU_CheckedChanged"></asp:CheckBox>
                                        </td>
                                        <td style="width: 5%"></td>
                                        <td style="width: 10%"></td>
                                        <td style="width: 45%"></td>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblquantity" runat="server" Width="73px" Height="16px" ForeColor="White"
                                                    Font-Bold="True" Text="Rcvd Qty" CssClass="lblbox" BackColor="#006699"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="Label6" runat="server" Width="73px" Height="16px" ForeColor="White"
                                                    Font-Bold="True" Text="Rejected Qty" CssClass="lblbox" BackColor="#006699"></asp:Label>
                                            </td>
                                             <td>
                                                <asp:Label ID="Label8" runat="server" Width="73px" Height="16px" ForeColor="White"
                                                    Font-Bold="True" Text="Accepted Qty" CssClass="lblbox" BackColor="#006699"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="Label9" runat="server" Width="73px" Height="16px" ForeColor="White"
                                                    Font-Bold="True" Text="Batch Fault Qty" CssClass="lblbox" BackColor="#006699"></asp:Label>
                                            </td>
                                            ...
                                            <td style="height: 16px" align="center">
                                              ...
                                              <td style="height: 16px" align="center">
                                                <asp:Label ID="Label5" runat="server" Width="100%" Height="16px" ForeColor="White"
                                                    Font-Bold="True" Text="Fault Reason" CssClass="lblbox" BackColor="#006699" Enabled="False"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtReceivedQty" onkeyup="Calculate();" runat="server" Width="70px"
                                                    CssClass="txtBox "></asp:TextBox>

                                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" FilterType="Numbers"
                                                    TargetControlID="txtReceivedQty">
                                                </ajaxToolkit:FilteredTextBoxExtender>
                                            </td>
                                             <td>
                                                <asp:TextBox ID="txtRejectedQty" onkeyup="Calculate();"  runat="server" Width="70px"
                                                    CssClass="txtBox "></asp:TextBox>

                                                <ajaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" FilterType="Numbers"
                                                    TargetControlID="txtRejectedQty">
                                                </ajaxToolkit:FilteredTextBoxExtender>
                                            </td>
                                              <td>
                                            ...
                                            <td>
                                                 <asp:TextBox ID="txtBatchFaultQty"  runat="server" Width="70px"
                                                    CssClass="txtBox "></asp:TextBox>
                                                  <ajaxToolkit:FilteredTextBoxExtender 
                                                      ID="FilteredTextBoxExtender2" runat="server" 
                                                      FilterType="Numbers" TargetControlID="txtBatchFaultQty"></ajaxToolkit:FilteredTextBoxExtender>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtBatchNo" runat="server" Width="76px" CssClass="txtBox" Enabled="False">N/A</asp:TextBox>
                                            </td>
                                             <td>
                                                <asp:DropDownList ID="drpReason" runat="server" Width="86px" CssClass="txtBox"></asp:DropDownList>
                                            </td>
                                            <td>
                                        ...
                                        <tr><td><asp:TextBox ID="txtFreeSKU" Visible="false" runat="server" Width="70px" CssClass="txtBox" Enabled="False">0</asp:TextBox>
                                              </td></tr>
                                        <tr>
                                                ...
                                                <asp:Panel ID="Panel2" runat="server" Width="100%" Height="130px" ScrollBars="Vertical"
                                                    ...
                                                    <asp:GridView ID="GrdPurchase" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="Received_Quantity" ReadOnly="true" HeaderText="Quantity">
                                                                <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="2px" HorizontalAlign="Right"
                                                                    Width="75px" />
                                                            </asp:BoundField>

                                                             <asp:BoundField DataField="Rejected_Quantity" ReadOnly="true" HeaderText="Quantity">
                                                                <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="2px" HorizontalAlign="Right"
                                                                    Width="75px" />
                                                            </asp:BoundField>
                                                             ...
                                                             <asp:BoundField DataField="Batch_fault_Quantity" ReadOnly="true" HeaderText="Quantity">
                                                                <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="2px" HorizontalAlign="Right"
                                                                    Width="75px" />
                                                            </asp:BoundField>
                                                            ...
                                                            <asp:BoundField DataField="BATCH_NO" ReadOnly="true" HeaderText="BatchNo">
                                                             ...
                                                             <asp:BoundField DataField="FAULT_REASON" ReadOnly="true" HeaderText="FAULT_REASON">
                                                                <ItemStyle BorderColor="Silver" BorderStyle="Solid" BorderWidth="1px" HorizontalAlign="Right" />
                                                            </asp:BoundField>
                                                              <asp:BoundField DataField="FAULT_ID" ReadOnly="true" HeaderText="FAULT_REASON">
                                                                   <HeaderStyle CssClass="HidePanel" />
                                                                <ItemStyle CssClass="HidePanel" />   </asp:BoundField>

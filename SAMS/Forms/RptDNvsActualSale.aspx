<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/PageMaster.master" AutoEventWireup="true" CodeFile="RptDNvsActualSale.aspx.cs" Inherits="Forms_RptDNvsActualSale" %>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="height: 25px" align="left">
                                        <asp:DropDownList ID="drpDistributor"  OnSelectedIndexChanged="drpDistributor_SelectedIndexChanged" runat="server" Width="200px" CssClass="DropList"
                                        AutoPostBack="true">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <strong>
                                            <asp:Label ID="Label2" runat="server" CssClass="lblbox" Text="Sale Force" Width="73px"></asp:Label></strong>
                                    </td>
                                    <td align="left">
                                    </td>
                                    <td align="left" style="height: 25px">

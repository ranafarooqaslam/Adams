...
public partial class pr_rptAdvance : System.Web.UI.Page
{
    ...
    protected void ShowReport(int ReportType)
    {
        try
        {
            ...
            DataTable dtList = ec.GetAdvance(Convert.ToInt32(Session["WorkingCompanyID"]), Convert.ToInt32(ddlLocation.SelectedValue), Convert.ToInt32(ddlDepartment.SelectedValue), Convert.ToInt32(ddlContractType.SelectedValue), Convert.ToInt32(ddlEmployee.SelectedValue),dtFrom,dtTo);

            SAMSBusinessLayer.Reports.PayrollReports.CrpAdvance CrpReport = new SAMSBusinessLayer.Reports.PayrollReports.CrpAdvance();
            ...
            CrpReport.SetParameterValue("Month", Convert.ToDateTime(txtFromDate.Text));

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pr_rptAdvanceIssuanceSlip.aspx.cs" Inherits="pr_rptAdvanceIssuanceSlip"
    MasterPageFile="~/Forms/PageMaster.master" Title="Advance Issuance Slip"%>
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" style="height: 25px">
                                            <strong>
                                                <asp:Label ID="Label1" runat="server" Text="Employee" Width="90px"></asp:Label></strong>
                                        </td>
                                        <td align="left" style="width: 1px; height: 25px">
                                        </td>
                                        <td align="left" style="width: 203px; height: 25px">
                                            <asp:DropDownList ID="ddlEmployee" runat="server" Width="210px">                                                
                                            </asp:DropDownList>
                                        </td>
                                        <td align="left" style="width: 1px; height: 25px">
                                        </td>
                                     ...
                                     <tr>
                                        ...
                                        <td style="height: 25px" align="left">
                                            <strong>
                                                <asp:Label ID="Label3" runat="server" Width="59px" Text="For Month"></asp:Label></strong>
                                        </td>
                                        <td style="width: 1px; height: 25px" align="left">
                                        </td>
                                        <td style="width: 203px; height: 25px" align="left">

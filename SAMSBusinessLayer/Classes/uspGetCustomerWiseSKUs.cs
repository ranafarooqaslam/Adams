...
{
	public class uspGetCustomerWiseSKUs
	{
		#region Private Members
		private string sp_Name = "uspGetCustomerWiseSKUs" ;
        ...
        {
            set { m_DATE_EFFECTED = value; }
            get { return m_DATE_EFFECTED; }
        }
